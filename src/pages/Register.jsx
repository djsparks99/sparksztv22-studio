    ...
    <AuthShell title="CLAIM YOUR FREQUENCY" subtitle="NEW BROADCASTER">
      ...
      <div className="mb-6 space-y-2.5" data-testid="oauth-providers-container">
        <button
          ...
          disabled={loading}
          className="flex w-full items-center justify-center gap-3 border border-[#333] bg-[#141416] py-2.5 font-mono text-xs font-bold uppercase tracking-wider text-white transition hover:border-[#e5ff00] hover:text-[#e5ff00]"
        >
